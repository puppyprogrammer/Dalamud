...
{
    private const string DalamudChangelogUrl = "https://ffxivplugins.commslink.net/Dalamud/Release/Changelog";
    private const string PluginChangelogUrl = "https://ffxivplugins.commslink.net/Plugin/History/{0}?track={1}";
